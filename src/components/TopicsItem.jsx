...
function TopicsItem({name, icon, description}) {
    ...
    return (
        <div className="w-full bg-neutral-900 flex justify-between items-center gap-3 p-2 md:rounded-md cursor-pointer md:mt-4 mt-2 hover:bg-neutral-950 transition-colors duration-200 px-4 rounded flex-col">
